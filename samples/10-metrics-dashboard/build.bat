...
%DCC64% ^
  ...
  "-U%BDS%\lib\Win64\release;.;..\..\src;..\..\middlewares" ^
  "-I.;..\..\src;..\..\middlewares" ^
  "-E.\bin\Release" ^
  "-N0.\dcu\Release" ^
  Poseidon.Sample.MetricsDashboard.dpr

if %ERRORLEVEL% equ 0 (
  echo.
  echo Compilacao concluida: bin\Release\Poseidon.Sample.MetricsDashboard.exe
) else (
  echo.
  echo FALHA na compilacao ^(errorlevel %ERRORLEVEL%^)
)
endlocal
